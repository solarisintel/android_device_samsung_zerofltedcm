...
ifeq ($(TARGET_SCREEN_WIDTH),)
    ...
    ANIMATION_HEIGHT := 175 
endif

ifeq ($(TARGET_SCREEN_WIDTH),720)
    TARGET_SCREEN_HEIGHT := 1280
    ANIMATION_HEIGHT := 115 
endif
...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	@rm -rf $(dir $@)
	@mkdir -p $(dir $@)
	$(hide) tar xfp device/samsung/zerofltedcm/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	...
	if [ "$(TARGET_BOOTANIMATION_HALF_RES)" = "true" ]; then \
            echo "Bootanimation is half res"; \
	...
	echo "$$IMAGESCALEWIDTH $(ANIMATION_HEIGHT) 45" > $(INTERMEDIATES)/desc.txt; \
	cat device/samsung/zerofltedcm/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
